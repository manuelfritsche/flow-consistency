...
from semseg.loss.loss import cross_flow
from semseg.loss.loss import cross_entropy2d
from semseg.loss.loss import bootstrapped_cross_entropy2d
from semseg.loss.loss import multi_scale_cross_entropy2d


logger = logging.getLogger('semseg')

key2loss = {'cross_flow': cross_flow,
